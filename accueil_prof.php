...
?>
    ...
    <body>
         <fieldset><legend>accueil professeur</legend>
             <form id="accueil" action="ident_entreprise.php" method="post">
                <br>
                    <input class='buttonstage' type="button" name="button stage 1 "value="propositions de stages" id="propstage">      <br><br>
                    <input class='buttonstage' type="button" name="button stage 2 "value="stages valider" id="">   <br><br>
                <br>
